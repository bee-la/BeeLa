...
public class BD extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase bd) {
        ...
        bd.execSQL("create table perfilUsuario(_id integer primary key autoincrement, id_usuario interger not null , nome_perfil text not null, comida text not null, musica text not null);");
